  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center text-white/60 mt-4 md:text-lg lg:text-xl max-w-md mx-auto">See how i transformed concepts into engaging digital experience</p>
        <div className="flex flex-col mt-10">
          <div className="flex flex-col gap-12 mt-10 md:mt-20">
            {portfolioProjects.map(project => (
              <div key={project.title} className="bg-gray-800 rounded-3xl relative overflow-hidden z-0 after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 pr-8 pl-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-28 after:pointer-events-none">
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                  ...
                  <Image src={project.image} alt={project.title} className="mt-8 -mbt-4 md:mb-0 lg:mt-0 lg:absolute lg:h-full lg:w-auto lg:max-w-none" />
                  </div>
                </div>
              </div>
